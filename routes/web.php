...
Route::get('/login','logincontoller@index')->name('login.userlist');
Route::post('/login','logincontoller@login')->name('login');
Route::get('/logout','logincontoller@logout')->name('logout');
